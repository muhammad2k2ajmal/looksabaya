...
if (isset($_REQUEST['delete']) && $_REQUEST['delete'] == 'y') {
    ...
    $checkQuery = "SELECT COUNT(*) FROM product_categories WHERE category_id = $id";
    $count = $db->getProductCount($checkQuery);
  
    if ($count > 0) {
        $_SESSION['errmsg'] = 'Cannot delete this category because it is associated with products.';
    } else {
                                ...
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto"> 
                                            <form class="row g-2">
                                                <div class="col-auto">
                                                    <a href="add-category.php" class="btn btn-primary login-btn">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0" id="datatable_1">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $categoryQuery = $admin->getAllCategories();
                                                ...
                                                ?>
                                                    <tr>                                                        
                                                        ...
                                                        <td class="text-end">                                                       
                                                            <a href="add-category.php?id=<?php echo base64_encode($row['id']); ?>">
