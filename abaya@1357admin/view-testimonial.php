                                ...
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <form class="row g-2">
                                                <div class="col-auto">
                                                    <a href="add-testimonial.php" class="btn btn-primary login-btn">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0" id="datatable_1">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $testimonialQuery = $admin->getAllTestimonials();
                                                foreach ($testimonialQuery as $row) :
                                                ?>
                                                    <tr>
                                                        <td><?php echo $i++; ?></td>
                                                        <td><?php echo $row['name']; ?></td>
                                                        <td><?php echo strlen($row['testimonial']) > 50 ? substr($row['testimonial'], 0, 50) . '...' : $row['testimonial']; ?></td>
