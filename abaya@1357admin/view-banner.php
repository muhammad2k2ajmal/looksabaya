...
if (isset($_REQUEST['delete']) && $_REQUEST['delete'] == 'y') {
    ...
    $sqlSelectData = $banner->getBanner($id);
    ...
    if ($sqlSelectData) {
      ...
      if ($sqlDelete == true) {
        $_SESSION['msg'] = 'Banner successfully deleted ..!!';
      } else {
        $_SESSION['errmsg'] = 'Sorry !! Some Error Occurred .. Try Again';
      }
    }
                                ...
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto"> 
                                            <form class="row g-2">
                                                <div class="col-auto">
                                                    <a href="add-banner.php" class="btn btn-primary login-btn">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>                                                        
                                                        ...
                                                        <td class="text-end">                                                       
                                                            <a href="add-banner.php?id=<?php echo base64_encode($row['id']); ?>">
