...
if (isset($_REQUEST['submit'])) {
    ...
    $result = $products->addProducts($category_id, $name, $price, $discount, $stock, $sizes, $files, $videofiles, $description, $lists, $trending, $new_arrivals, $best_selling, $status, $colors, $color_images);
...
if (isset($_REQUEST['update'])) {
    ...
    $result = $products->updateProducts($id, $category_id, $name, $price, $discount, $stock, $sizes, $files, $videofiles, $description, $lists, $trending, $new_arrivals, $best_selling, $status, $colors, $color_images);
