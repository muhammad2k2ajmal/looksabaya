                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-5">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="color" class="form-control form-control-color" id="color_picker" value="#FFFFFF">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-5">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="color" class="form-control form-control-color" id="color_picker" value="<?php echo htmlspecialchars($editval['color_code'] ?? '#FFFFFF'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
...
<script>
    $(document).ready(function () {
        ...
        $("#color_picker").on("input", function () {
            $("#color_code").val(this.value);
            $("#color_code").trigger("change");
        });
