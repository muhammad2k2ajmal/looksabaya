                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        <div class="col">                      
                                            <h4 class="card-title">View Visitors</h4>                      
                                        </div>
                                    </div>                                
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0" id="datatable_1">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $visitorQuery = $db->getAllData("SELECT * FROM `visitors_history` ORDER BY `id` DESC");
                                                foreach ($visitorQuery as $row) :
                                                ?>
                                                    <tr>                                                        
                                                        <td><?php echo $i++; ?></td>
                                                        <td><?php echo $row['visitor_ip']; ?></td>
                                                        <td><?php echo $row['visitor_browser']; ?></td>
                                                        <td><?php echo $row['visitor_date']; ?></td>
                                                        <td><?php echo $row['visitor_page']; ?></td>                                            
                                                    </tr>
                                                <?php endforeach; ?>                                                                                    
                                            </tbody>
                                        </table>
