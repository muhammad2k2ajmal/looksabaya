...
<style>
	...
	padding: 0.5px 3px;       /* minimal padding */
	border-radius: 1.5px;     /* tighter corners */
	margin-left: 3px;
		...
		<div class="main-header">
				...
				<div class="container">
					<div class="row align-items-center justify-content-between">
							...
							<div class="col-3 d-flex align-items-center row">
								...
								<div class="offcanvas offcanvas-start" tabindex="-1" id="mobileMenu"
									...
									<div class="offcanvas-body p-0">
										...
										<div class="collapse border-bottom" id="mobileAccountMenu">
											<?php if (isset($_SESSION['USER_LOGIN'])): ?>
												<a href="account.php"
													class="list-group-item list-group-item-action px-3 py-2 d-flex align-items-center">
												...
												<?php else: ?>
													<?php foreach ($categories as $index => $cat): ?>
														<a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"
															<?php if ($cat['id'] == 1): ?>
																href="explore-all.php?cid=<?php echo base64_encode($cat['id']); ?>"
															<?php else: ?> data-bs-toggle="collapse"
																href="#subCat<?php echo $cat['id']; ?>" aria-expanded="false"
																aria-controls="subCat<?php echo $cat['id']; ?>" <?php endif; ?>>
						...
						<div class="col-4 col-md-6 d-none d-md-block">
							...
							<div class="position-relative w-50 mx-auto">
								<input type="text" id="searchInput" class="form-control rounded-pill ps-3 pe-5"
									placeholder="What are you looking for?" />

								<!-- Search Icon as a Button -->
								<span class="position-absolute top-50 end-0 translate-middle-y pe-3 text-muted"
									style="cursor: pointer;" onclick="redirectToSearch()">
								...
								<div class="dropdown">
									<?php if (isset($_SESSION['USER_LOGIN'])): ?>
										<div class="d-flex align-items-center">
											...
											<a class="icon-link me-3 position-relative dropdown-toggle text-decoration-none text-black"
												href="#" role="button" id="accountDropdown" data-bs-toggle="dropdown"
												aria-expanded="false">
									...
									<?php else: ?>
										...
										<ul class="dropdown-menu" aria-labelledby="accountDropdown">
											...
											<li><a class="dropdown-item" href="register.php">Create New Account</a></li>
										</ul>
									<?php endif; ?>
								</div>
							</div>
					...
					<div class="collapse navbar-collapse mt-2 mt-md-0" id="mainNav">
						<ul class="navbar-nav nav-menu mx-auto">
							<li class="nav-item">
								<a class="nav-link" href="explore-all.php">Explore
									All</a>
							</li>
							<li class="nav-item">
								<a class="nav-link"
								...
								<div class="mega-menu">
									<div class="mega-container d-flex">
										...
										<div class="mega-sidebar me-4">
											...
											<?php else: ?>
												<?php foreach ($categories as $index => $cat): ?>
													<a href="<?php echo $cat['id'] == 1 ? 'explore-all.php?cid=' . base64_encode($cat['id']) : '#'; ?>"
														class="<?php echo $cat['id'] == 1 ? ' ' : 'sidebar-link'; ?> <?php echo $index === 0 ? 'active' : ''; ?>"
													...
													<div class="mega-col-group d-flex <?php echo $index !== 0 ? 'd-none' : ''; ?>"
														...
														<?php else: ?>
															<?php foreach ($subcategories as $subcat): ?>
																<div class="mega-col">
																	<a
																		href="explore-all.php?cid=<?php echo base64_encode($cat['id']); ?>&scid=<?php echo base64_encode($subcat['id']); ?><?php echo $urlParam; ?>">
																	...
																	<ul>
																		...
																		<?php else: ?>
																			<?php foreach ($subsubcategories as $subsubcat): ?>
																				<li>
																					<a
																						href="explore-all.php?cid=<?php echo base64_encode($cat['id']); ?>&scid=<?php echo base64_encode($subcat['id']); ?>&sscid=<?php echo base64_encode($subsubcat['id']); ?><?php echo $urlParam; ?>">
																						<?php echo htmlspecialchars($subsubcat['name']); ?>
																						<?php if ($subsubcat['new'] == 1): ?>
																							<span class="new-badge">New</span>
																						<?php endif; ?>
			...
			<div class="header-bottom">
				...
				<div class="position-relative search-bar">
					<input type="text" id="searchInput1" class="form-control rounded-pill ps-3 pe-5"
						placeholder="What are you looking for?" />
										...
										<div class="mega-container d-flex">
											<div class="mega-sidebar me-4">
												...
												<?php else: ?>
													<?php foreach ($categories as $index => $cat):
														?>
														<a href="<?php if ($cat['id'] == '1') {
															echo 'explore-all.php?cid=' . base64_encode(1);
														} else {
															echo '#';
														} ?>" class="<?php echo $cat['id'] == 1 ? ' ' : 'sidebar-link'; ?> <?php echo $index === 0 ? 'active' : ''; ?>"
