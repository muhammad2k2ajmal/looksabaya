...
// Define credentials 
$clientId = 'SU2502151323233136146146';
$clientSecret = '7862df60-634f-4652-b372-acbebc536c83';
$clientVersion = 1;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $merchantTransactionId = 'PEURA' . time() . rand(1000, 9999);
    ...
    $data = [
        ...
        "paymentFlow" => [
            ...
            "merchantUrls" => [
                 'redirectUrl' => 'https://peuraopticals.com/update-shipping1.php?transactionId=' . $merchantTransactionId . '&shipId=' . $shipId . '&type=' . $type,
                 'redirectMode' => 'POST',
                 'callbackUrl' => 'https://peuraopticals.com/update-shipping1.php?transactionId=' . $merchantTransactionId . '&shipId=' . $shipId . '&type=' . $type,
            ]
        ]
    ];
